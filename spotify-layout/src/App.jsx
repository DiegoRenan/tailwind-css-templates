                    ...
                    <div className="items-end flex-1 text-white font-bold hidden md:flex">
                        <nav className="flex-1">
                            <ul className="flex justify-end flex-1">
                                <li className="px-4"><a className="hover:text-spotify-hover" href="#">Premium</a></li>
                                <li className="px-4"><a className="hover:text-spotify-hover" href="#">Ajuda</a></li>
                                <li className="px-4"><a className="hover:text-spotify-hover" href="#">Baixar</a></li>
                                <li className="px-4"><span className="border-r border-white"></span></li>
                                <li className="px-4"><a className="hover:text-spotify-hover" href="#">Inscrever-se</a></li>
                                <li className="px-4"><a className="hover:text-spotify-hover" href="#">Log-in</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
